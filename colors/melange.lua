...
for name, attrs in pairs {
  ...
  -- RenderMarkdownH5 = {},
  -- RenderMarkdownH6 = {},
  RenderMarkdownH1Bg = { bg = d.orange },
  RenderMarkdownH2Bg = { bg = d.yellowish },
  RenderMarkdownH3Bg = { bg = d.green },
  RenderMarkdownH4Bg = { bg = d.orange },
  RenderMarkdownH5Bg = { bg = d.yellowish },
  RenderMarkdownH6Bg = { bg = d.green },
  RenderMarkdownCode = 'NormalFloat',
  -- RenderMarkdownCodeInfo = {},
  -- RenderMarkdownCodeBorder = {},
  -- RenderMarkdownCodeFallback = {},
  RenderMarkdownCodeInline = 'CursorLine',
  -- RenderMarkdownQuote = {},
